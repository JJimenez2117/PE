...
namespace PE03._JimenezRamirezJulioFabian
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("El indice de la ultima ocurrencia del elemento más grande del vector es {0}",(vector.ToList().LastIndexOf(vector.Max())+1));
            Console.ReadKey();
